...
import net.darkmeow.loader.xz.XZIOException;
import net.darkmeow.loader.xz.CorruptedInputException;

public class IndexHash extends IndexBase {
    private net.darkmeow.loader.xz.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new net.darkmeow.loader.xz.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new net.darkmeow.loader.xz.check.CRC32();
        }
    }
