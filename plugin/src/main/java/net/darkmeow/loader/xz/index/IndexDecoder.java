...
package net.darkmeow.loader.xz.index;

import java.io.IOException;
import java.io.EOFException;
import java.util.zip.CheckedInputStream;
import net.darkmeow.loader.xz.common.DecoderUtil;
import net.darkmeow.loader.xz.common.StreamFlags;
import net.darkmeow.loader.xz.SeekableInputStream;
import net.darkmeow.loader.xz.CorruptedInputException;
import net.darkmeow.loader.xz.MemoryLimitException;
import net.darkmeow.loader.xz.UnsupportedOptionsException;
