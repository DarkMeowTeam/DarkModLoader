...
import net.darkmeow.loader.xz.lz.LZDecoder;
import net.darkmeow.loader.xz.rangecoder.RangeDecoderFromBuffer;
import net.darkmeow.loader.xz.lzma.LZMADecoder;
